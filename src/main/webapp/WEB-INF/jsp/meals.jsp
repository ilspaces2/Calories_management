...
<section>
    ...
    <form method="get" action="meals/filter">
        <dl>
            <dt><spring:message code="meal.dateFrom.inclusive"/></dt>
            <dd><input type="date" name="startDate" value="${param.startDate}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.dateTo.inclusive"/></dt>
            <dd><input type="date" name="endDate" value="${param.endDate}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.timeFrom.inclusive"/></dt>
            <dd><input type="time" name="startTime" value="${param.startTime}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.timeTo.exclusive"/></dt>
